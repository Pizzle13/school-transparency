...
| Date | Change | Details |
|------|--------|---------|
| 2026-03-11 | Add hero image: Cairo | Added Unsplash hero image (Cairo cityscape) to fallback `FALLBACK_IMAGES` mapping and master `public/data/cities.json`. Supabase `hero_image_url` was null, so used fallback pattern. Image: Giza pyramids cityscape. Stats: $40K salary, low cost of living, 8 schools. Page: /cities/cairo |
